import type { InfraNodeConfig, ConnectionConfig, NodeId } from './types';

export const TILE_WIDTH = 200;
export const TILE_HEIGHT = 100;

export const NODES: InfraNodeConfig[] = [
...
export function isoProject(gridX: number, gridY: number, centerX: number, centerY: number): { x: number; y: number } {
  return {
...
export function getNodeConfig(id: NodeId): InfraNodeConfig {
