...
export class Cityscape extends Container {
    ...
    arcade = new Graphics();
    arcadeGhosts = new Graphics();
    spaceNeedle = new Graphics();
    spaceNeedleBeacon = new Graphics();
    trees = new Graphics();
    neonPools = new Graphics();
    neonSigns = new Graphics();
    mysteryData = new Graphics();
    arcadeBanner = new Graphics();
    ...
    powerPillTimer = 0; // seconds remaining, 0 = off
    // UFO attack effect
    ufoAttack = new Graphics();
    ufoTimer = 0; // seconds remaining, 0 = off
    ufoPhase = 0; // animation progress
    constructor() {
        super();
    ...
    drawSpaceNeedle() {
        ...
        for (const [lx, ly] of [[x - legSpread, baseY], [x + legSpread, baseY], [x, baseY + 5]]) {
            // Glow stroke behind
    ...
    update(dt) {
        ...
        this.arcadeBanner.clear();
        {
            ...
            for (let s = 0; s < segCount; s++) {
                ...
                if (t1 < t0)
                    continue; // skip wrap-around segment
