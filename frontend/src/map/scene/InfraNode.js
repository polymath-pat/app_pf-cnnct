...
export class InfraNode extends Container {
    ...
    serviceDetails = new Graphics();
    serviceAnim = new Graphics();
    replicantEye = new Graphics();
    nameLabel;
    ...
    animate = (ticker) => {
        ...
        switch (this.config.id) {
            case 'frontend':
                this.animFrontend(ticker);
                break;
            case 'backend':
                this.animBackend(ticker);
                break;
            case 'dns':
                this.animDns(ticker);
                break;
