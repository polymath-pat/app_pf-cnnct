...
export class MapScene {
    ...
    batmanGfx = new Graphics();
    batmanFromX = 0;
    batmanFromY = 0;
    batmanToX = 0;
    batmanToY = 0;
    batmanProgress = -1; // -1 = perched, 0-1 = jumping
    batmanIdleTimer = 0;
    batmanIdleWait = 7;
    batmanCurrentNode = 'frontend';
    batmanFacingRight = true;
    batmanElapsed = 0;
    constructor(app) {
        this.app = app;
    ...
    updateBatman(dt) {
        ...
        const nodeIds = ['frontend', 'backend', 'valkey', 'postgres', 'opensearch', 'dns'];
